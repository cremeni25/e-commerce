...
function cremeni_store_asset_version(string $relativePath): string { $p=get_template_directory().$relativePath; if(is_file($p)){return (string)filemtime($p);} $theme=wp_get_theme(); return $theme->get('Version')?:'0.6.0'; }

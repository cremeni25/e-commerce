...
function cremeni_store_layout_guard(): void
{
    ...
    <style id="cremeni-layout-guard">
        ...
        @media (max-width:900px) {
            .cremeni-container { width:min(calc(100% - 32px),100%)!important; }
...
/**
 * Universos comerciais oficiais definidos na matriz CREMENI.
 */
function cremeni_store_product_categories(): array
{
    return [
        'esporte' => [
            ...
            'description' => __('Compra principal: produtos esportivos selecionados, com dropshipping nacional e margem protegida.', 'cremeni-store'),
        ],
        'pet-mimos' => [
            'label'       => __('Pet Mimos', 'cremeni-store'),
            'description' => __('Cross-sell leve e afetivo para ampliar recorrência sem transformar a compra em outra decisão de alto valor.', 'cremeni-store'),
        ],
        'guias-cremeni' => [
            'label'       => __('Guias CREMENI', 'cremeni-store'),
            'description' => __('Conteúdo proprietário sobre corpo, mente, rotina, bem-estar, pets e convivência.', 'cremeni-store'),
        ],
    ];
}
